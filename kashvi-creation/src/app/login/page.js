    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-300">
      ...
      <div className="w-96 bg-white shadow-lg rounded-lg p-6">
        ...
        <form className="flex flex-col gap-4">
          <input type="email" placeholder="Email" className="border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-teal-400" />
          <input type="password" placeholder="Password" className="border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-teal-400" />
          <p className="text-right text-sm text-gray-600 underline cursor-pointer">Forgot Password?</p>
          <button className="bg-slate-400 text-white font-bold rounded-full py-2 shadow-md hover:bg-slate-500">Log in</button>
        </form>
